...
export class GanttTemplate {
  static myChangingSelection = false;
  ...
  static make(
    ...
    myTask.addDiagramListener('TreeCollapsed', (e: any) =>
      myGantt.layoutDiagram(true)
    );
    myTask.addDiagramListener('TreeExpanded', (e: any) =>
      myGantt.layoutDiagram(true)
    );
    ...
    myGantt.addDiagramListener('ChangedSelection', (e: any) => {
      ...
      e.diagram.selection.each((part: any) => {
        if (part instanceof go.Node)
          bars.push(myTask.findNodeForData(part.data));
      });
  ...
  static makeTask(
    ...
    const myTasks = new go.Diagram(divId, {
      ...
      padding: new go.Margin(
        ...
        0
      ), // needs to be the same vertically as for myGantt
  ...
  static makeGantt(
    ...
    const myGantt = new go.Diagram(divId, {
      ...
      'resizingTool.cellSize': new go.Size(
        GanttUtility.GridCellWidth,
        GanttUtility.GridCellHeight
      ),
      'resizingTool.minSize': new go.Size(
        GanttUtility.GridCellWidth,
        GanttUtility.GridCellHeight
      ),
      // layout: $(GanttLayout),
      ...
      DocumentBoundsChanged: (e) => {
        ...
        myGrid.desiredSize = new go.Size(
          b.width + GanttUtility.GridCellWidth * 7,
          b.bottom
        );
        ...
        myTimeline.graduatedMax =
          Math.ceil(b.width / (GanttUtility.GridCellWidth * 7)) *
          (GanttUtility.GridCellWidth * 7);
    ...
    myGantt.nodeTemplate = $(
      ...
      new go.Binding(
        'position',
        'start',
        GanttUtility.convertStartToPosition
      ).makeTwoWay(GanttUtility.convertPositionToStart),
      ...
      $(
        ...
        new go.Binding(
          'width',
          'duration',
          GanttUtility.convertDurationToW
        ).makeTwoWay(GanttUtility.convertWToDuration),
      ...
      $(
        ...
        $(go.Shape, 'LineV', {
          ...
          alignmentFocus: new go.Spot(
            ...
            0,
            0,
            -GanttUtility.TimelineHeight / 2
          ), // tick marks cross over the timeline itself
          stroke: 'lightgray',
          strokeWidth: 0.5,
        }),
        $(go.TextBlock, {
